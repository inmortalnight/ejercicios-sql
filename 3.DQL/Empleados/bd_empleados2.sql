...
/*Consultas*/
select avg(salario) from empleados where dept_no = 20;

select count(*) from empleados;

select count(*) from empleados where comision is not null and comision > 0;

select max(salario) from empleados;

select apellido from empleados order by apellido asc limit 1;
...
select count(dept_no) from empleados;
select dept_no, count(*) from empleados group by dept_no;

select count(*) from empleados where apellido like 'a%';

select apellido from empleados where salario = (select max(salario) from empleados where apellido like 'a%');